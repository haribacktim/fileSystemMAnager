...
public class RequestSenderService {
    ...
    public long createDirectory(String path){
        ...
        String url = baseUrl + port + "/fileSystem-web/webresources/filesystem/directories";
    ...
    public long uploadFile(String path, String destination){
        ...
        String url = baseUrl + port + "/fileSystem-web/webresources/filesystem/files/";
    ...
    public long downloadFile(String path){
        HttpURLConnection con = null;
        String url = baseUrl + port + "/fileSystem-web/webresources/filesystem/files/download/" + path;
        try {
        URL myurl = new URL(url);
        con = (HttpURLConnection) myurl.openConnection();
    ...
    public void deleteDirectory(String path) {
        HttpURLConnection con = null;
        String url = baseUrl + port + "/fileSystem-web/webresources/filesystem/directories/"+ path;
        try {
            URL myurl = new URL(url);
            con = (HttpURLConnection) myurl.openConnection();
